    ...
    AccessControlUpgradeable
{
    ...
    /* ========== STATE VARIABLES ========== */
    IERC20Upgradeable public share; // STARS/BUSD || STARS
    ...
    IERC20Upgradeable public radiance;
    ...
    function initialize(IERC20Upgradeable _radiance, IERC20Upgradeable _share)
        public
        initializer
    {
        ...
        rewardLockupEpochs = 1; // Lock for 1 epochs (6h) before release claimReward
    }
    ...
    function bigBang(address _treasury) public onlyRole(OPERATOR_ROLE) {
    ...
    function getRadiancePrice() external view returns (uint256) {
        return treasury.getRadiancePrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            radiance.safeTransfer(msg.sender, reward);
        ...
        nonReentrant
    {
        ...
        radiance.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(radiance), "Radiance");
        require(address(_token) != address(share), "Share Token");
